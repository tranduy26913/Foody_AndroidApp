...
public class MakeData {
    ...
    public void MakeData(){
        ...
        try {
            ...
            Shop s1 = new Shop(new Date().getTime(), "Gogi House - Quán Nướng Hàn Quốc - Saigon Centre",
            ...
            shopList.add(s1);
            Shop s2 = new Shop(new Date().getTime(), "Thành Mập - Chân Gà Rút Xương Ngâm Sả Tắc - Bạch Đằng - Shop Online",
                    ...
                    "94/22/2A Phú Thọ Hòa, P. Phú Thọ Hòa, TP.Thủ Đức, TP.HCM", "Shop Online", 9.4);
            shopList.add(s2);
            Shop s3 = new Shop(new Date().getTime(), "Bánh Mì Tuấn Mập - Nguyễn Thị Nhỏ",
                    "Ship toàn Thủ Đức", "https://images.foody.vn/res/g4/32218/prof/s640x400/foody-mobile-banh-mi-tuan-map-tp-hcm.jpg",
                    "https://images.foody.vn/res/g105/1041514/s120x120/2b06d3a1-dbfb-4a88-a672-f94878a8-a63f4179-201119124832.jpeg",
                    "94/22/2A Phú Thọ Hòa, P. Phú Thọ Hòa, TP.Thủ Đức, TP.HCM", "Shop Online", 9.4);
            shopList.add(s3);
            Shop s4 = new Shop(new Date().getTime(), "Pergola - Cafe Nhà Hàng Sân Vườn",
                    ...
                    "94/22/2A Phú Thọ Hòa, P. Phú Thọ Hòa, TP.Thủ Đức, TP.HCM", "Shop Online", 9.4);
            shopList.add(s4);
            Shop s5 = new Shop(new Date().getTime(), "Tân Hương Nam Quán - Mì Sụa Bạc Liêu & Bánh Canh",
                    ...
                    "94/22/2A Phú Thọ Hòa, P. Phú Thọ Hòa, TP.Thủ Đức, TP.HCM", "Shop Online", 9.4);
            shopList.add(s5);
            Shop s6 = new Shop(new Date().getTime(), "Chilli Thai - Lý Tự Trọng",
...
//Shop2
            ...
            for (Food f : foodList) {
                ...
                db.collection(GLOBAL.FOOD_COLLECTION)
                        .document(String.valueOf(f.getId()))
                        .set(f);
                Thread.sleep(1);
            }
        } catch (Exception ex) {
